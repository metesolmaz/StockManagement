package com.metesolmaz.stockmanagement.productservice.controller;
...
import com.metesolmaz.stockmanagement.productservice.response.ProductResponse;
...
class ProductController {
    ...
    public InternalApiResponse<ProductResponse> getProduct(@PathVariable("language")Language language,
        ...
        ProductResponse productResponse = convertProductResponse(product);
        log.debug("[{}][getProduct] -> request productId: {}", this.getClass().getSimpleName(), productResponse);
        return InternalApiResponse.<ProductResponse>builder()
